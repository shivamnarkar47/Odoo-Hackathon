...
const UserProfile: React.FC<UserProfileProps> = ({ user, onBack }) => {
  ...
  const averageRating =
    user.reviews.reduce((sum, review) => sum + review.score, 0) /
    user.reviews.length;
            ...
            <div className="mt-4 w-full space-y-3">
              ...
              <div className="flex items-center justify-between py-2 border-b border-muted">
                ...
                <span className="flex items-center gap-1">
                  ...
                  {averageRating.toFixed(1)} ({user.reviews.length} reviews)
                </span>
              </div>
          ...
          <div className="bg-card border border-muted rounded-xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-muted">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                {user.reviews.length} reviews with an average rating of{" "}
