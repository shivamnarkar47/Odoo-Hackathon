...
class User(AbstractUser):
    ...
    skills_offered = models.ManyToManyField(Skills, related_name='users_offering', blank=True)
    skills_wanted = models.ManyToManyField(Skills, related_name='users_wanting', blank=True)
    ...
    is_public = models.BooleanField(default=True, help_text="Make profile public or private")
